...
function changeMe(moneyIn){
    console.log(moneyIn)
    return (/^£5$/).test(moneyIn) ? `20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p`
    : (/^£2$/).test(moneyIn) ? `20p 20p 20p 20p 20p 20p 20p 20p 20p 20p`
    : (/^£1$/).test(moneyIn) ? `20p 20p 20p 20p 20p`
    : (/^50p$/).test(moneyIn) ? `20p 20p 10p`
    : (/^20p$/).test(moneyIn) ? `10p 10p` : moneyIn
  }